...
namespace AtCor{ 
	namespace Scor { 
		namespace DataAccess{
			...
			*/
			public ref class DalEM4Command
			{
				...
				private:
					...
					static unsigned char _dataCapturePacketSequenceNumber;
				...
				public:
					...
					*/
					...
					property unsigned char DataCapturePacketSequenceNumber
					{
						unsigned char get()
						{
							unsigned char returnValue;
							
							returnValue = _dataCapturePacketSequenceNumber<<4;
							
							_dataCapturePacketSequenceNumber++;
							_dataCapturePacketSequenceNumber = _dataCapturePacketSequenceNumber%16;
					...
					*/
					...
					//new constructor to recreate PC command from an array recieved from serial port
					DalEM4Command(array<unsigned char>^ sourcePCCommandArray);
					...
					*/
					...
					bool ValidateCommandCRC();

					DalEM4Command(Byte inCommandCode, unsigned char seqNo, array<Byte>^ inCommandData, unsigned short statusBytes);
					bool TranslateUnsignedShort( array <unsigned char>^ destinationArray, int startPostion, unsigned short sourceUS);
			...
			*/
			private ref class CRC8Calculator
			{
				private:
					...
					CRC8Calculator^ operator= (const CRC8Calculator);
