								...
								*/
								public ref class DalConstants
								{
									public:
										...
										static const unsigned int SimulationTimerInterval   = 125; // in msec
										static const unsigned int SimulationNumberOfReadsPerInterval = 32; /**< Number of items to read from tonometer sim file in each interval.*/
