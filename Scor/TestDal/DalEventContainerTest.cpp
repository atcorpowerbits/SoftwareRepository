...
#pragma endregion
	...
	public: [TestMethod]
			...
			void RegisterEventsTestTest()
			{
				...
				actual->OnDalModuleErrorAlarmEvent(this, gcnew DalModuleErrorAlarmEventArgs( errFlag, nullptr, DalAlarmSource::RecoverableStatus)); //TODO: Deepak Put an appropriate string
