    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {               
                ...
                guicmbxSqlServerList.DisplayMember = "ServerName";//Need to come from resource string              
                this.Text = "Available Databases";//Need to come from resource string  
                labelMesg.Text = "Select server to create/delete database:";//Need to come from resource string  
                button1.Text = "Ok";//Need to come from resource string 
                button2.Text = "Cancel";//Need to come from resource string 
                
            }
            catch (Exception exObj)
            {
                //TODO: Add proper exception handling and error mechanism
                MessageBox.Show(exObj.Message, "Scor System Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }        
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (outputMesgArr.Length > 0 && outputErrCode == 1)
                {
                    ...
                    MessageBox.Show(output, "Scor Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
