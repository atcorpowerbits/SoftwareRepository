...
#pragma endregion
	...
	public: [TestMethod]
			...
			void LookForResponseToCommandTest()
			{
				...
				target->LookForResponseToCommand(commandCodeToLocate, expectedResponseLengthToLocate, expectedSequenceNumberToLocate);
	...
	public: [TestMethod]
			...
			void ExtractAckedResponsePacketTest()
			{
				...
				target->LookForResponseToCommand(0x0B, 0x11, 0x00); 
	...
	public: [TestMethod]
			...
			void ExtractNackedResponsePakcetTest()
			{
				...
				target->EnqueueArray(expected);
				//set the "lookout command"
				target->LookForResponseToCommand(0x0B, 0x11, 0x00); //sequence number and length dont matter since the expected response is a nack
