...
class TPressure: public TPWASignal
{
  ...
  private:
    ...
    bool CalculateTrigPts(const int pAlgorithm, const int pMinTrigPt, bool singlePulse = false);
    ...
    bool CalcPulses(bool pRejectExtraPulses, const int pTail, bool singlePulse = false);
