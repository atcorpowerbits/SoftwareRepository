...
const int CAPTURE_PWM_OUTPUT_REFRESH_RATE = 500;   // Number of pulses

const int CAPTURE_MAX_PULSES = CAPTURE_SECS_TOTAL * MAX_HR / 60;
...
extern int        capture_successful_pulses[];
extern int        capture_pulse_index;
extern int        capture_nof_pulses;
extern bool       capture_pulse_buff_full;

void capture_reset(MEAS_ID_TYPE meas_id);
void capture_reset_pwm_output();
//---------------------------------------------------------------------------
#endif
