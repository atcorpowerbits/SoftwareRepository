...
namespace TestBiz {
    ...
    /// <summary>
///This is a test class for BizMPTest and is intended
///to contain all BizMPTest Unit Tests
///</summary>
	[TestClass]
	public ref class BizMPTest
	{
...
#pragma endregion
			...
			///</summary>
	public: [TestMethod]
			void BizMPValidateTest()
			{
				BizMP^  target = (gcnew BizMP()); // TODO: Initialize to an appropriate value
				bool actual;
				...
				target->Reading = 100; // normal test
				actual = target->Validate();
				Assert::AreEqual(true, actual);
