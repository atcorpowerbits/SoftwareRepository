...
//-- var, const, procedure ---------------------------------------------------
#define SDLVersionInfo "streams_r820_full"
...
extern PACKAGE int __fastcall CountLinesInStream(Classes::TStream* Instream);
extern PACKAGE int __fastcall ReadNextTagInStream(const Classes::TStream* AStream, const AnsiString * TagList, const int TagList_Size, AnsiString &Attrib, AnsiString &Contents);
extern PACKAGE int __fastcall ReadNextTagInTextFile(const TextFile &AFile, const AnsiString * TagList, const int TagList_Size, AnsiString &Attrib, AnsiString &Contents);
