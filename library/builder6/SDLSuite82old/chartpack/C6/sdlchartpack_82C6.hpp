...
// (DO NOT EDIT: machine generated header) 'sdlchartpack_82C6.pas' rev: 6.00

#ifndef sdlchartpack_82C6HPP
#define sdlchartpack_82C6HPP
...
#include <sdlcolors.hpp>	// Pascal unit
#include <datatable.hpp>	// Pascal unit
#include <filesys.hpp>	// Pascal unit
...
#include <univconst.hpp>	// Pascal unit
...
#include <rot3d.hpp>	// Pascal unit
#include <rcproped.hpp>	// Pascal unit
#include <rchart.hpp>	// Pascal unit
#include <scale.hpp>	// Pascal unit
#include <plot3d.hpp>	// Pascal unit
#include <SysInit.hpp>	// Pascal unit
#include <System.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Sdlchartpack_82c6
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Sdlchartpack_82c6 */
using namespace Sdlchartpack_82c6;
#pragma option pop	// -w-
#pragma option pop	// -Vx

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// sdlchartpack_82C6
