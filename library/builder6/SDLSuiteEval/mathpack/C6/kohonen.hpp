...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TKHFeedbackEvent)(System::TObject* Sender, double PercentDone);
...
protected:
	void __fastcall DoFeedback(double PercentDone);
...
__published:
	...
	__property TKHFeedbackEvent OnFeedback = {read=FOnFeedback, write=FOnFeedback};
};
