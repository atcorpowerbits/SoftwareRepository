...
int main (void)
{
	...
	DEFINE_TEST_SUITE(check_image_tests_suite, check_image_tests, "Check downloaded image in DataFlash unit tests suite");
	
	// Run all tests in the test suite.
	test_suite_run(&check_image_tests_suite);
